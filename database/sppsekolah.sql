...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2021 at 07:56 AM
...
(23, '201810001', 'hanggara P A', 1, '2018/2019', 250000),
(24, '201810002', 'Meyki Ardiansyah', 2, '2018/2019', 250000),
(25, '201810003', 'Chandra Wijaya', 3, '2018/2019', 250000),
(26, '201810004', 'Dedi Marlin Hidayat', 4, '2018/2019', 250000),
(27, '201810005', 'Novian Sandi Putra', 5, '2018/2019', 250000),
(28, '201810006', 'Rina Puspita Sari', 6, '2018/2019', 250000),
(29, '201810007', 'Jeki Sanjaka', 7, '2018/2019', 250000),
(30, '201810008', 'Andry Al-febri', 8, '2018/2019', 250000),
(31, '201810009', 'Atang Al-Farizi', 9, '2018/2019', 250000);
...
(3, 23, '2018-12-10', 'Desember  2018', '2102160001', '2021-02-16', 250000, 'LUNAS', 1),
...
INSERT INTO `walikelas` (`id_kelas`, `kelas`, `idguru`) VALUES
(1, 'VII A', 1),
(2, 'VII B', 9),
(3, 'VII C', 11),
(4, 'VIII A', 4),
...
--
ALTER TABLE `siswa`
  ADD CONSTRAINT `siswa_ibfk_1` FOREIGN KEY (`kelas`) REFERENCES `walikelas` (`id_kelas`);
